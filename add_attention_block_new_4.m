function [lgraph]=add_attention_block_new_4(coarsefeatures,finefeatures,destination,attention_tag,lgraph,channels,upsamplingRatio)
% compatability score version
attentionlayers = attention_block_new_4(attention_tag,channels,upsamplingRatio);
