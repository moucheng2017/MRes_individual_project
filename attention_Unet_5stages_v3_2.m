function [lgraph,networkname]=attention_Unet_5stages_v3_2(height,width)
networkname='attention_network_5stages_v3_2';
% U net with attention
lgraph = createUnet(5);
larray=imageInputLayer([height width 3],'Name','Input','Normalization','None');
lgraph=replaceLayer(lgraph,'ImageInputLayer',larray);
[lgraph]=add_attention_block_v3('Encoder-Stage-5-ReLU-2','Decoder-Stage-1-upBN-1','Decoder-Stage-1-DepthConcatenation','bridge',lgraph);
