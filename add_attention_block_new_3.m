function [lgraph]=add_attention_block_new_3(coarsefeatures,finefeatures,destination,attention_tag,lgraph,channels)
% compatability score version
attentionlayers = attention_block_new_3(attention_tag,channels);
