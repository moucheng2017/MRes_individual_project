function [lgraph]=add_attention_block_mixed_1(coarsefeatures,finefeatures,destination,attention_tag,lgraph,channels)
% compatability score version
attentionlayers = attention_block_mixed_1(attention_tag,channels);
