function [lgraph]=add_attention_block_mixed_2(coarsefeatures,finefeatures,destination,attention_tag,lgraph,channels,upsamplingRatio)
% compatability score version
attentionlayers = attention_block_mixed_2(attention_tag,channels,upsamplingRatio);
