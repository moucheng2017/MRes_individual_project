function [lgraph,networkname]=resnet12_Unet_attention_v1_4_new(classes,netWidth,height,width,beta)
lgraph=resnet12_Unet_new(classes,netWidth,height,width,beta);
networkname='resnet12_Unet_attention_v1_4_new';
