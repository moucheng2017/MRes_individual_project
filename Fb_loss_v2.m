classdef Fb_loss_v2 < nnet.layer.ClassificationLayer
% original fb sum loss without smoothing   
    properties
        betavalue
    ...
    methods
        function layer = Fb_loss_v2(name,beta)           
        ...
        function loss = forwardLoss(layer, Y, T)
            ...
            fb_coe=(fb_numerator)/(fb_denominator);
            loss=1-fb_coe;
        end
        ...
        function dLdY = backwardLoss(layer, Y, T)
            ...
            gradient_numerator=(1+b^2)*T*((b^2)*sum_p1_g0+sum_p0_g1);
            gradient_denominator=(sum_p0_g0*(1+b^2)+sum_p1_g0*(b^2)+sum_p0_g1).^2;
