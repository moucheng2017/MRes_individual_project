function [lgraph,networkname]=resnet8_Unet_v2_attention_v1_3_new_new(classes,netWidth,height,width,beta)
...
networkname='resnet8_Unet_v2_attention_v1_3_new_new';
...
%[lgraph]=add_attention_block_new_2('convInp','bridge_upconv','d1_contac','d1',lgraph,netWidth*1,16);
